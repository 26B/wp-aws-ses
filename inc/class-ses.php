...
class SES {
	...
	public function send_wp_mail( $to, $subject, $message, $headers = [], $attachments = [] ) {
		...
		// Replicate the WordPress filter for pre_wp_mail.
		...
		try {
			...
			// Replicate the WordPress action for failed mail sending.
		...
		// Replicate the WordPress action for successful mail sending.
